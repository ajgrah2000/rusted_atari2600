...
impl Atari2600 {
    ...
    pub fn draw_loop(&mut self, canvas: &mut render::Canvas<video::Window>, pixel_format: pixels::PixelFormatEnum, window_size: &graphics::display::WindowSize, iterations: u32, audio_queue: &mut dyn sound::SoundQueue) -> bool {
            ...
            if self.core.memory.stella.export() {
                ...
                canvas
                    .copy(
                        &texture,
                        None,
                        Some(rect::Rect::new(0, 0, graphics::stella::Constants::PIXEL_WIDTH_STRETCH as u32 * window_size.console_width as u32, window_size.console_height as u32)),
                    )
                    .unwrap();
                canvas.present();
            }
