...
impl AddressingIZX {
    ...
    pub fn address(
        ...
        let tmp8 = memory
            .read(clock, pc_state.get_pc().wrapping_add(1))
            .wrapping_add(pc_state.get_x());
...
impl AddressingZPX {
    ...
    pub fn address(
        ...
        (memory
            .read(clock, pc_state.get_pc().wrapping_add(1))
            .wrapping_add(pc_state.get_x())) as u16
    }
}
...
impl AddressingZPY {
    ...
    pub fn address(
        ...
        (memory
            .read(clock, pc_state.get_pc().wrapping_add(1))
            .wrapping_add(pc_state.get_y())) as u16
    }
}
