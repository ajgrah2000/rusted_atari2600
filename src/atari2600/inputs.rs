...
impl UserInput {
    ...
    pub fn print_keys() {
        ...
        println!(
            "Up: {}, Down: {}, Left: {}, Right: {}",
            UserInput::KEY_1_UP,
            UserInput::KEY_1_DOWN,
            UserInput::KEY_1_LEFT,
            UserInput::KEY_1_RIGHT
        );
        ...
        println!(
            "Up: {}, Down: {}, Left: {}, Right: {}",
            UserInput::KEY_2_UP,
            UserInput::KEY_2_DOWN,
            UserInput::KEY_2_LEFT,
            UserInput::KEY_2_RIGHT
        );
    ...
    pub fn handle_events(event: event::Event, joystick: &mut Joystick) -> bool {
        match event {
            event::Event::Quit { .. }
            | event::Event::KeyDown {
                keycode: Some(UserInput::KEY_QUIT),
                ..
            } => return false,

            event::Event::KeyDown {
                keycode: Some(UserInput::KEY_1_UP),
                ..
            } => {
                joystick.j1_up(true);
            }
            event::Event::KeyDown {
                keycode: Some(UserInput::KEY_1_DOWN),
                ..
            } => {
                joystick.j1_down(true);
            }
            event::Event::KeyDown {
                keycode: Some(UserInput::KEY_1_LEFT),
                ..
            } => {
                joystick.j1_left(true);
            }
            event::Event::KeyDown {
                keycode: Some(UserInput::KEY_1_RIGHT),
                ..
            } => {
                joystick.j1_right(true);
            }
            event::Event::KeyDown {
                keycode: Some(UserInput::KEY_1_FIRE),
                ..
            } => {
            ...
            event::Event::KeyDown {
                keycode: Some(UserInput::KEY_2_UP),
                ..
            } => {
                joystick.j2_up(true);
            }
            event::Event::KeyDown {
                keycode: Some(UserInput::KEY_2_DOWN),
                ..
            } => {
                joystick.j2_down(true);
            }
            event::Event::KeyDown {
                keycode: Some(UserInput::KEY_2_LEFT),
                ..
            } => {
                joystick.j2_left(true);
            }
            event::Event::KeyDown {
                keycode: Some(UserInput::KEY_2_RIGHT),
                ..
            } => {
                joystick.j2_right(true);
            }
            event::Event::KeyDown {
                keycode: Some(UserInput::KEY_2_FIRE),
                ..
            } => {
            ...
            event::Event::KeyDown {
                keycode: Some(UserInput::KEY_RESET),
                ..
            } => {
                joystick.reset(true);
            }
            event::Event::KeyDown {
                keycode: Some(UserInput::KEY_SELECT),
                ..
            } => {
